...
class Application(Frame):
    def __init__(self, master):
        ...
        self.history = Text(master, height=10, width=30, font=("Arial", 14))
        self.history.grid(row=0, column=7, rowspan=5, padx=10)
        self.history.insert(END, "Computation History:\n")
        self.create_widgets()
...
root = Tk()
root.title("Tkinter Calcu Babyyy")
root.iconbitmap("IloveYouHuniBunchSugarPlumPumiyunPiyum.ico")
root.geometry()
